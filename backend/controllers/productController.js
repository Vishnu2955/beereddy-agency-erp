...
const addProduct = async (req, res) => {
  try {
    ...
    const product = await Product.create({
      ...
      sellingPrice: sPrice,
      mrp: mPrice,
      bulkTier1Price: req.body.bulkTier1Price != null ? Number(req.body.bulkTier1Price) : sPrice,
      bulkTier2Price: req.body.bulkTier2Price != null ? Number(req.body.bulkTier2Price) : Math.round(sPrice * 0.92),
      bulkTier3Price: req.body.bulkTier3Price != null ? Number(req.body.bulkTier3Price) : Math.round(sPrice * 0.85),
      gst: taxRate,
